...
# Read goal from /eddie2sim_ws/src/eddie2sim_navigation/text/goal_simulation_surveillance.txt file and keep goals in list
def sim_read_goal_surveillance():
    goal_path = "{}/eddie2sim_ws/src/eddie2sim_navigation/text/".format(home)
